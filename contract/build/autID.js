...
let Contract = (_dec = NearBindgen({
  requireInit: true
}), _dec2 = initialize({}), _dec3 = call({}), _dec4 = call({}), _dec5 = call({
  privateFunction: true
}), _dec6 = call({}), _dec7 = call({}), _dec8 = call({}), _dec9 = call({}), _dec10 = view({}), _dec11 = view({}), _dec12 = view({}), _dec13 = view({}), _dec14 = view({}), _dec15 = view({}), _dec16 = call({}), _dec17 = call({}), _dec18 = call({}), _dec(_class = (_class2 = class Contract {
  // Counter
  tokenId = 1; // NFT props

  tokensPerOwner = new LookupMap('tokensPerOwner');
  tokens = new UnorderedMap('tokens'); // AutID props 

  holderToDAOMembershipData = new UnorderedMap('holderToDAOMembershipData');
  holderToDAOs = new UnorderedMap('holderToDAOs');
  autIDByOwner = new UnorderedMap('autIDByOwner');
  autIDUsername = new UnorderedMap('autIDUsername');
  autIDToDiscordID = new UnorderedMap('autIDToDiscordID');
  discordIDToAddress = new UnorderedMap('discordIDToAddress');
  /*
  ...
  */
  ...
  addDiscordIDToAutID(discordID) {
    let autID = this.autIDByOwner[predecessorAccountId()];
    this.autIDToDiscordID[autID] = discordID;
    this.discordIDToAddress[discordID] = predecessorAccountId(); // TODO: emit event 
  ...
  nft_mint({
    ...
    assert(commitment > 0 && commitment < 11, "AutID: Commitment should be between 1 and 10");
    assert(daoExpander.length > 0, "AutID: Missing DAO Expander");
    assert(this.tokensPerOwner[predecessorAccountId()] == undefined, "AutID: There is AutID already registered for this address.");
    assert(this.autIDUsername[username] == undefined, "AutID: Username already taken!");
    const promise = NearPromise.new(daoExpander).functionCall("is_member_of_original_DAO", bytes(JSON.stringify({
      member: predecessorAccountId()
    })), NO_DEPOSIT, FIVE_TGAS).then(NearPromise.new(currentAccountId()).functionCall("nft_mint_callback", bytes(JSON.stringify({
  ...
  nft_mint_callback({
    ...
    this.tokens[this.tokenId.toString()] = {
      owner_id: accountID,
    ...
    this.tokenId++;
    return this.tokenId - 1; // const promise = NearPromise.new(daoExpander)
  ...
  joinDAO({
    ...
    assert(commitment > 0 && commitment < 11, "AutID: Commitment should be between 1 and 10");
    assert(daoExpander.length > 0, "AutID: Missing DAO Expander");
    assert(this.tokensPerOwner[predecessorAccountId()] == 1, "AutID: There is no AutID registered for this address.");
    let currentComs = this.holderToDAOs[predecessorAccountId()];

    for (let index = 0; index < currentComs.length; index++) {
      assert(currentComs[index] != daoExpander, "AutID: Already a member");
    } // TODO: implement
    // require(
    ...
    let userDAOs = this.holderToDAOs[predecessorAccountId()];
    let totalCommitment = 0;

    for (let index = 0; index < userDAOs.length; index++) {
      totalCommitment += this.holderToDAOMembershipData[predecessorAccountId()][userDAOs[index]].commitment;
    }

    assert(totalCommitment + commitment < 11, "Maximum commitment reached"); // TODO: implement
    // assert(
    //     IDAOExpander(daoExpander).isMemberOfOriginalDAO(near.predecessorAccountId()),
    //     "AutID: Not a member of this DAO!"
    // );

    this.holderToDAOMembershipData[predecessorAccountId()][daoExpander] = {
      daoExpanderAddress: daoExpander,
      role,
      commitment,
      isActive: true
    };
    this.holderToDAOs[predecessorAccountId()].push(daoExpander);
    NearPromise.new(daoExpander).functionCall("join", bytes(JSON.stringify({
      newMember: predecessorAccountId()
    })), NO_DEPOSIT, FIVE_TGAS); // TODO: emit event
  ...
  withdraw({
    ...
    assert(this.holderToDAOMembershipData[predecessorAccountId()][daoExpander].isActive, "AutID: Not a member");
    this.holderToDAOMembershipData[predecessorAccountId()][daoExpander].isActive = false;
    this.holderToDAOMembershipData[predecessorAccountId()][daoExpander].commitment = 0; //TODO: emit event
  ...
  editCommitment({
    ...
    assert(this.holderToDAOMembershipData[predecessorAccountId()][daoExpander].isActive, "AutID: Not a member");
    assert(newCommitment > 0 && newCommitment < 11, "AutID: Commitment should be between 1 and 10"); // TODO: find a better way
    // assert(
    ...
    assert(totalCommitment + newCommitment - this.holderToDAOMembershipData[predecessorAccountId()][daoExpander].commitment < 11, "Maximum commitment reached");
    this.holderToDAOMembershipData[predecessorAccountId()][daoExpander].commitment = newCommitment; // TODO: emit event
  ...
  setMetadataUri({
    ...
    assert(this.tokensPerOwner[predecessorAccountId()] == 1, "AutID: Doesn't have an AutID.");
    let tokenId = this.autIDByOwner[predecessorAccountId()];
    this.tokens[tokenId].metadata = metadataUri; // TODO: emit event
  ...
  getAutIDByOwner({
    ...
    assert(this.tokensPerOwner[autIDOwner] == 1, "AutID: The AutID owner is invalid.");
  ...
  getTotalCommitment({
    ...
    assert(this.tokensPerOwner[autIDHolder] == 1, "AutID: The AutID owner is invalid.");
    let userDAOs = this.holderToDAOs[autIDHolder];
    let totalCommitment = 0;

    for (let index = 0; index < userDAOs.length; index++) {
      totalCommitment += this.holderToDAOMembershipData[autIDHolder][userDAOs[index]].commitment;
    }
...
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "addDiscordIDToAutID", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "addDiscordIDToAutID"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "nft_mint", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "nft_mint"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "nft_mint_callback", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "nft_mint_callback"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "joinDAO", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "joinDAO"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "withdraw", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "withdraw"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "editCommitment", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "editCommitment"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "setMetadataUri", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "setMetadataUri"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getHolderDAOs", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "getHolderDAOs"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getMembershipData", [_dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "getMembershipData"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getAutIDByOwner", [_dec12], Object.getOwnPropertyDescriptor(_class2.prototype, "getAutIDByOwner"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getTotalCommitment", [_dec13], Object.getOwnPropertyDescriptor(_class2.prototype, "getTotalCommitment"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getAutIDHolderByUsername", [_dec14], Object.getOwnPropertyDescriptor(_class2.prototype, "getAutIDHolderByUsername"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "nft_token", [_dec15], Object.getOwnPropertyDescriptor(_class2.prototype, "nft_token"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "nft_transfer", [_dec16], Object.getOwnPropertyDescriptor(_class2.prototype, "nft_transfer"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "nft_transfer_call", [_dec17], Object.getOwnPropertyDescriptor(_class2.prototype, "nft_transfer_call"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "nft_resolve_transfer", [_dec18], Object.getOwnPropertyDescriptor(_class2.prototype, "nft_resolve_transfer"), _class2.prototype)), _class2)) || _class);
...
function getAutIDHolderByUsername() {
  let _state = Contract._getState();
  ...
  let _result = _contract.getAutIDHolderByUsername(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contract._serialize(_result));
}
function getTotalCommitment() {
  let _state = Contract._getState();
  ...
  let _result = _contract.getTotalCommitment(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contract._serialize(_result));
}
function getAutIDByOwner() {
  let _state = Contract._getState();
  ...
  let _result = _contract.getAutIDByOwner(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contract._serialize(_result));
}
function getMembershipData() {
  ...
  let _result = _contract.getMembershipData(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contract._serialize(_result));
}
function getHolderDAOs() {
  let _state = Contract._getState();
  ...
  let _result = _contract.getHolderDAOs(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contract._serialize(_result));
}
function setMetadataUri() {
  ...
  let _result = _contract.setMetadataUri(_args);
...
function editCommitment() {
  ...
  let _result = _contract.editCommitment(_args);
...
function withdraw() {
  ...
  let _result = _contract.withdraw(_args);
...
function joinDAO() {
  ...
  let _result = _contract.joinDAO(_args);

  Contract._saveToStorage(_contract);

  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contract._serialize(_result));
}
function nft_mint_callback() {
  let _state = Contract._getState();
  ...
  let _result = _contract.nft_mint_callback(_args);
...
function addDiscordIDToAutID() {
  ...
  let _result = _contract.addDiscordIDToAutID(_args);
...
export { Contract, NFT_METADATA_SPEC, NFT_STANDARD_NAME, addDiscordIDToAutID, editCommitment, getAutIDByOwner, getAutIDHolderByUsername, getHolderDAOs, getMembershipData, getTotalCommitment, init, joinDAO, nft_mint, nft_mint_callback, nft_resolve_transfer, nft_token, nft_transfer, nft_transfer_call, setMetadataUri, withdraw };
//# sourceMappingURL=autID.js.map
